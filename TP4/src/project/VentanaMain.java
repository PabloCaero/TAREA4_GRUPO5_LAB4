...
public class VentanaMain extends JFrame{
	...
	private JFrame ventanaSO;
	
	
	public VentanaMain(JFrame ventContacto ,JFrame ventPromedio ,JFrame ventSO)
	{
		...
		boton3.addActionListener(new EventoAbrirVentana(ventanaSO));
